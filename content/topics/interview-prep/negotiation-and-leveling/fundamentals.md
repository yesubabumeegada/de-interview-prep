---
title: "Negotiation & Leveling — Fundamentals"
...
```mermaid
flowchart TD
    A[Total compensation] --> B[Base salary<br/>monthly cash, most stable]
    A --> C[Bonus<br/>% of base, company/personal performance]
    A --> D[Equity<br/>RSUs / options, vesting over ~4 yrs]
    A --> E[One-time: signing bonus,<br/>relocation]
    A --> F[Non-cash: remote policy, on-call,<br/>learning budget, pension/401k match]
```
