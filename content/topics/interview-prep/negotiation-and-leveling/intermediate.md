---
title: "Negotiation & Leveling — Intermediate Concepts"
...
```mermaid
flowchart LR
    A[Stagger applications:<br/>practice tier 1-2 wks early] --> B[Compress screens]
    B --> C[Land onsites in one<br/>2-week window]
    C --> D[Offers overlap ->
leverage exists]
    D --> E[Use honestly:<br/>numbers, in writing,<br/>no bluffing]
```
